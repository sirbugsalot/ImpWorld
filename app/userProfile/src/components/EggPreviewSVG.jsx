...
const EggPreviewSVG = ({ color, shape }) => {
    ...
    const shapeWaistPercentage = shape.waist/shape.height;// (shape.height - shape.waist +10)/(shape.height + 10); // This is the height of the waist point FROM THE EGG'S BOTTOM, as a percentage of the total egg height.
