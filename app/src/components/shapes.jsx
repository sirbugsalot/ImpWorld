        ...
        <>
            ...
            <Path 
                d={`M ${pos.x + 0.5*0.8*wx} ${pos.y - 0.45*hy} 
                   Q ${pos.x + 1.0*wx + reach(2)} ${pos.y - 0.46*hy}, ${pos.x + 0.5*1.1*wx + reach(2.5)} ${pos.y - 0.5*hy}
                   Q ${pos.x + 0.5*1.2*wx + reach(3)} ${pos.y - 0.6*hy}
                   Q ${pos.x + 0.5*1.3*wx + reach(3)} ${pos.y - 0.47*hy}
                   Q ${pos.x + 0.5*1.25*wx + reach(3)} ${pos.y - 0.45*hy}, ${pos.x - 0.5*1.2*wx + reach(3)} ${pos.y - 0.4*hy}
