        ...
        <>
            ...
            <Path 
                d={`M ${pos.x - 0.5*0.95*wx} ${pos.y - 0.4*hy} 
                   ...
                   T ${pos.x - reach(0.5*0.22*wx)} ${pos.y - 0.20*hy}, ${pos.x - reach(0.5*0.3*wx)} ${pos.y - 0.27*hy}
                   T ${pos.x - reach(0.5*0.22*wx)} ${pos.y - 0.30*hy}, ${pos.x - reach(0.5*0.4*wx)} ${pos.y - 0.3*hy}
                   T ${pos.x - reach(0.5*0.4*wx)} ${pos.y - 0.40*hy}, ${pos.x - reach(0.5*0.5*wx)} ${pos.y - 0.3*hy}
