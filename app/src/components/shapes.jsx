        ...
        <>
            ...
            <Path 
                d={`M ${ref_x + 7.5} ${ref_y + 1.5} 
                   Q ${ref_x + 15.0} ${ref_y - 5.5 - reach(5)}, ${ref_x + 18.0} ${ref_y - 7.0 - reach(5)}
                   Q ${ref_x + 19.2} ${ref_y - 6.4 - reach(5)}, ${ref_x + 19.5} ${ref_y + 15.6}
                   Q ${ref_x + 13.5} ${ref_y + 6.0}, ${ref_x + 7.5} ${ref_y + 1.5}
                   M ${ref_x - 21.0} ${ref_y + 18.0} 
                   Q ${ref_x - 27.9} ${ref_y + 1.0 - reach(5)}, ${ref_x - 27.0} ${ref_y - 4.0 - reach(5)}
                   Q ${ref_x - 21.0} ${ref_y - 2.5 - reach(5)}, ${ref_x - 6.5} ${ref_y + 6.0}
            ...
            <Path 
                d={`M ${ref_x + 12.9} ${ref_y + 4.5} 
                   Q ${ref_x + 16.5} ${ref_y - 3.4 - reach(5)}, ${ref_x + 18.0} ${ref_y - 5.5 - reach(5)}
                   Q ${ref_x + 18.3} ${ref_y - 1.0 - reach(5)}, ${ref_x + 18.0} ${ref_y + 8.0}
                   M ${ref_x - 20.4} ${ref_y + 15.0} 
                   Q ${ref_x - 26.7} ${ref_y - 0.5 - reach(5)}, ${ref_x - 25.8} ${ref_y - 2.5 - reach(5)}
                   Q ${ref_x - 22.5} ${ref_y - 0.4 - reach(5)}, ${ref_x - 17.1} ${ref_y + 8.0}
                   `}
                stroke="#d59b95" 
                strokeWidth="0.25" 
                fill="#eac3b5"
...
export const Mouth = ({pos, shape, color, length = 1.0 }) => {
    ...
    const leftCorner = { x: ref_x - (10/2) - reach(2), y: ref_y + 30 };
    const rightCorner = { x: ref_x + (10/2) + reach(2), y: ref_y + 30 };
    const upperLip_R = 10.0;
    const lowerLip_R = 25.0;
        ...
        <>
            ...
            <Path 
                d={`M ${leftCorner.x} ${leftCorner.y}
                    ...
                    A ${mouthWidth} ${lowerLip_R} 0 0 1 ${leftCorner.x} ${leftCorner.y} 
                   `} 
                stroke="#6b4646" 
                strokeWidth="0.01" 
                fill="#6c3939"
            ...
            <Path 
                d={`M ${teethLeftCorner.x} ${teethLeftCorner.y}
                    L ${teethLeftCorner.x} ${ref_y + 32.6}
                    A ${teethWidth} ${upperLip_R} 0 0 0 ${teethRightCorner.x} ${ref_y + 32.6}
                    L ${teethRightCorner.x} ${teethRightCorner.y}
                    A ${teethWidth} ${upperLip_R} 0 0 1 ${teethLeftCorner.x} ${teethLeftCorner.y} 
                   `} 
                stroke="#575757" 
                strokeWidth="0.01" 
                fill="#fdfdfd"
