        ...
        <>
            ...
            <Path 
                d={`M ${pos.x + 0.5*0.8*wx} ${pos.y - 0.4*hy} 
                   Q ${pos.x + 0.5*1.0*wx + reach(2)} ${pos.y - 0.42*hy}, ${pos.x + 0.5*1.2*wx + reach(2)} ${pos.y - 0.55*hy}
                   ...
                   Q ${pos.x + 0.5*1.1*wx + reach(2)} ${pos.y - 0.25*hy}, ${pos.x + 0.5*0.9*wx} ${pos.y - 0.25*hy}
                   `}
                stroke="#111" 
                strokeWidth="1" 
                fill={color}
